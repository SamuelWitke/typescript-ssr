...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(Header, { isBusy: this.props.isBusy, isAuthenticated: this.props.isAuthenticated, handleSignOut: this.signOut }),
            React.createElement("div", { className: "container-fluid" },
                React.createElement(Routes, { isAuthenticated: this.props.isAuthenticated }))));
    };
    App.prototype.signOut = function (e) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        e.preventDefault();
                        return [4 /*yield*/, this.props.signOut()];
                    case 1:
                        _a.sent();
